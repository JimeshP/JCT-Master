...
function populateReport(){
	...
	var headingString = "<table width='100%' class='etable'><thead class='tab_header'><tr><th width='12%'>"+headerDispTable[14]+"</th><th width='18%'>"+headerDispTable[0]+"</th><th width='18%'>"+headerDispTable[1]+"</th><th width='6%'>"+headerDispTable[13]+"</th><th width='30%'>"+headerDispTable[3]+"</th><th width='10%'>"+headerDispTable[4]+"</th><th width='8%'>"+headerDispTable[5]+"</th></tr></thead><tbody>";
